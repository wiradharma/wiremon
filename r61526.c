...
/**************************************************************************/
//inline 
void R61526_wr_cmd(DWORD cmd)
{
	R61526_DC_CLR();							/* DC=L						*/
#if DISPCMD_PIN_OFFSET>0
	cmd<<=DISPCMD_PIN_OFFSET;
#endif
...
/**************************************************************************/
//inline 
void R61526_wr_dat(DWORD dat)
{
#if DISPDATA_PIN_OFFSET>0
	dat<<=DISPDATA_PIN_OFFSET;
#endif
...
/**************************************************************************/
//inline 
void R61526_wr_gram(DWORD gram)
{
#if DISPDATA_PIN_OFFSET>0
	gram<<=DISPDATA_PIN_OFFSET;
#endif

#if defined(GPIO_ACCESS_8BIT) | defined(BUS_ACCESS_8BIT)
	R61526_DATA = (BYTE)(gram>>8);			/* upper 8bit data			*/
	R61526_WR();								/* WR=L->H					*/
#endif
...
/**************************************************************************/
//inline 
void R61526_wr_block(BYTE *p, unsigned int cnt)
{
...
/**************************************************************************/
//inline 
void R61526_rect(DWORD x, DWORD width, DWORD y, DWORD height)
{
...
//	DWORD n;
	...
	if(devicetype == 0xFFFF)//(devicetype == 0x1526)
	{
		/* Initialize R61526 */
		R61526_wr_cmd(0xB0);
		R61526_wr_dat(0x3F);
...
*/
/**************************************************************************/
DWORD R61526_draw_bmp(const BYTE* ptr){

	DWORD n, m, biofs, bw, iw, bh, w;
	DWORD xs, xe, ys, ye, i;
	BYTE *p;
	WORD d;
